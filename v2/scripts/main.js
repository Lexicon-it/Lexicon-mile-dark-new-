...
const programs = {
  ...
  mba: { title: 'MBA Global', category: 'POSTGRADUATE / GLOBAL BUSINESS', image: 'global', description: 'Explore globally focused MBA programmes with international academic partners across the UK, Malaysia, and UAE, offering dual-campus learning and global exposure. Choose from International Business, Business Analytics & AI, or Family Business Management, with opportunities to study across multiple campuses. Build global perspectives, industry-ready skills, and leadership capabilities through an immersive international MBA experience.', highlights: ['Global exposure and perspectives', 'International business', 'Strategic thinking', 'Cross-cultural learning and leadership'] },
  bba: { title: 'BBA', category: 'UNDERGRADUATE / BUSINESS', image: 'collaboration', description: 'A future-ready BBA at Lexicon MILE combining business fundamentals with AI, analytics, and hands-on industry exposure. Learn by doing through real-world projects, AI-powered tools, and practical business frameworks that build analytical and professional skills. Graduate as a confident Day Zero Professional, ready to adapt, innovate, and lead in an AI-driven business world.', highlights: ['Business foundations', 'Innovation and practical learning', 'Entrepreneurial thinking', 'Leadership development'] },
  ihm: { title: 'IHM / HMCT', category: 'HOSPITALITY / MANAGEMENT', image: 'hospitality', description: 'By the Hoteliers, For the Hoteliers. Lexicon HMCT combines academic excellence with hands-on industry exposure to prepare future leaders in hospitality, tourism, and hotel management. Build global perspectives, industry-ready skills, and a passion for service excellence to thrive in the evolving hospitality industry.', highlights: ['Hospitality and service excellence', 'Tourism and management', 'Practical industry training', 'Professional development'] }
};
